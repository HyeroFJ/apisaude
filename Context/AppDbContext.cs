...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Server=localhost;Port=5432;Database=saude;UserId=postgres;Password=senai901;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Entrega>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.CodPaciente, e.CodMatmed }, "cod_paciente_matmed");
        ...
        modelBuilder.Entity<Paciente>(entity =>
        {
            ...
            entity.HasIndex(e => e.CodPaciente, "idx_cartao_sus");

            entity.HasIndex(e => e.CodPaciente, "idx_cod_paciente");

            entity.HasIndex(e => e.CodPaciente, "idx_cpf");
